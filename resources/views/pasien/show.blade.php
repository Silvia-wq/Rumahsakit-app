...
<div class="card shadow mb-4">
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-md-6">
                        ...
                        @if($dataPasien->scan_ktp)
                            <p>
                                <a href="{{ asset('storage/' . $dataPasien->scan_ktp) }}" target="_blank">Lihat/Unduh KTP</a>
                            </p>
                        @else
                    ...
                    @if($dataPasien->scan_kberobat)
                        <p><a href="{{ asset('storage/' . $dataPasien->scan_kberobat) }}" target="_blank">Lihat/Unduh Kartu Berobat</a></p>
                    @else
    ...
    <div class="col-md-6">
        ...
        @if($dataPasien->scan_kbpjs)
            <p><a href="{{ asset('storage/' . $dataPasien->scan_kbpjs) }}" target="_blank">Lihat/Unduh BPJS</a></p>
        @else
    ...
    <div class="col-md-6">
        ...
        @if($dataPasien->scan_kasuransi)
            <p><a href="{{ asset('storage/' . $dataPasien->scan_kasuransi) }}" target="_blank">Lihat/Unduh Asuransi</a></p>
        @else
