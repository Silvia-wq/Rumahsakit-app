<!-- resources/views/jadwalpoliklinik/update.blade.php -->
        ...
        <form action="{{ route('jadwalpoliklinik.update', $jadwalpoliklinik->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="date" name="tanggal_praktek" id="tanggal_praktek" class="form-control"
                    value="{{ $jadwalpoliklinik->tanggal_praktek }}" required>
            </div>

            <div class="form-group">
                <label for="jam_mulai">Jam Mulai</label>
                <input type="time" name="jam_mulai" id="jam_mulai" class="form-control"
                    value="{{ $jadwalpoliklinik->jam_mulai }}" required>
            </div>

            <div class="form-group">
                <label for="jam_selesai">Jam Selesai</label>
                <input type="time" name="jam_selesai" id="jam_selesai" class="form-control"
                    value="{{ $jadwalpoliklinik->jam_selesai }}" required>
            </div>

            <div class="form-group">
                <label for="jumlah">Jumlah Pasien</label>
                <input type="number" name="jumlah" id="jumlah" class="form-control"
                    value="{{ $jadwalpoliklinik->jumlah }}" required>
            </div>
